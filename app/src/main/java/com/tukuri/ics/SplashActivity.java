    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == MY_PERMISSIONS_REQUEST_WRITE_FIELS) {
            if (grantResults.length > 0
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(com.tukuri.ics.SplashActivity.this);
...
if(sessionManagement.isLoggedIn()) {
    Intent in = new Intent(SplashActivity.this, AskNumber.class);
    startActivity(in);
    finish();
}
else
{
    ...
    public void openPermissionScreen() {
        ...
        Intent intent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS,
                Uri.fromParts("package", com.tukuri.ics.SplashActivity.this.getPackageName(), null));
