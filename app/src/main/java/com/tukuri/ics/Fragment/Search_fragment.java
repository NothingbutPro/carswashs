...
public class Search_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.tukuri.ics.MainActivity) getActivity()).setTitle(getResources().getString(R.string.search));
        ...
        try
        {       if (getArguments().getString("SProduct")!=null)
        {       pd = getArguments().getString("SProduct");      } }
        catch (Exception ex)
        {  ex.printStackTrace(); }

        if (pd.isEmpty()){      }

        else {   et_search.setText(""+pd);      makeGetProductRequest(pd);      }
