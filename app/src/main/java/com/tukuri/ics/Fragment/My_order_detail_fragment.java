...
import com.tukuri.ics.Adapter.My_order_detail_adapter;
import com.tukuri.ics.Config.BaseURL;
import com.tukuri.ics.Model.My_order_detail_model;
import com.tukuri.ics.R;
import com.tukuri.ics.AppPreference;
import com.tukuri.ics.ConnectivityReceiver;
import com.tukuri.ics.CustomVolleyJsonArrayRequest;
        ...
        CustomVolleyJsonArrayRequest jsonObjReq = new CustomVolleyJsonArrayRequest(Request.Method.POST,
            ...
            public void onResponse(JSONArray response) {
                ...
                for(int i=0;i<my_order_detail_modelList.size();i++) {
                    if (my_order_detail_modelList.get(i).getPlan_type().equals("monthly"))
                    {
                        totals = totals+ Float.valueOf(String.valueOf(Float.valueOf(my_order_detail_modelList.get(i).getMonthly_price())* Float.valueOf(my_order_detail_modelList.get(i).getQty())));
                    }else {
                        totals = totals+ Float.valueOf(String.valueOf(Float.valueOf(my_order_detail_modelList.get(i).getPrice())* Float.valueOf(my_order_detail_modelList.get(i).getQty())));
                    }
                }
                //++++++++++++++++++++++++++++++++Totals++++++++++++++++++++++++++++++++++++++++++
