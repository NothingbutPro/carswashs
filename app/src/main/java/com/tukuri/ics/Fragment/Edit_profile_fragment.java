...
import com.tukuri.ics.JSONParser;
import com.tukuri.ics.NameValuePair;
import com.tukuri.ics.Session_management;
import com.tukuri.ics.Utility;
...
public class Edit_profile_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.tukuri.ics.MainActivity) getActivity()).setTitle(getResources().getString(R.string.edit_profile));
...
//                    AppPreference.setMobile(getActivity(),getphone);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (response) {
                ...
                ((com.tukuri.ics.MainActivity) getActivity()).updateHeader();

                Toast.makeText(getActivity(), getResources().getString(R.string.profile_updated), Toast.LENGTH_SHORT).show();
                iv_profile.setImageResource(R.drawable.app_icon);
