...
import com.tukuri.ics.Fragment.Product_fragment;
import com.tukuri.ics.Fragment.Show_pro_detail_fragment;
...
public class Product_adapter extends RecyclerView.Adapter<Product_adapter.MyViewHolder>
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageView iv_logo, iv_plus, iv_remove;
        ...
        public MyViewHolder(View view) {
            ...
            iv_minus = (ImageView) view.findViewById(R.id.iv_subcat_img);
            ...
            RelativeLayout cardView = view.findViewById(R.id.rel_lyt);
        ...
        public void onClick(View view) {
            ...
            if (id == R.id.iv_subcat_plus) {
                ...
                //++++++++++++++++++++++++++++++++++++++++++For service++++++++++++++++++++++++++++
                //+++++++++++++++++++++++++++++++For service add++++++++++++++++++++++++++++++++++
                map.put("service", modelList.get(position).getService());
                map.put("no_of_plans", "1");
                map.put("monthly_price", modelList.get(position).getMonthly_price());
                //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//                context.startActivity(intent);
                ...
                args.putString("Deals_description", modelList.get(position).getDeals_desc());
                //++++++++++++++++++++++++++++++++New concept+++++++++++++
                args.putString("service",modelList.get(position).getService());
                args.putString("no_of_plans","0");
                args.putString("monthly_price",modelList.get(position).getMonthly_price());
                //+++++++++++++
...
//                        position, tv_contetiy.getText().toString());
    ...
    private void showImage(String image) {
       ...
       dialog.getWindow().setLayout(WindowManager.LayoutParams.FIRST_SUB_WINDOW, WindowManager.LayoutParams.FIRST_SUB_WINDOW);
        dialog.show();
