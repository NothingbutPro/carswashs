...
public class Cart_adapter extends RecyclerView.Adapter<Cart_adapter.ProductHolder> {
    ...
    public void onBindViewHolder(final ProductHolder holder, final int position) {
        ...
        try{
            if(!map.get("no_of_plans").equals("0")) {
                holder.service_txt.setText("Monthly:");
                holder.tv_no_month.setText(map.get("monthly_price"));
            }else {
                holder.service_txt.setText("Daily:");
                holder.tv_no_month.setText(map.get("price"));
            }
        }catch (Exception e)
        {
            e.printStackTrace();
        ...
        if (map.get("offer").equals("0"))
        {
            ...
            monthly_price =  Double.parseDouble(map.get("monthly_price"));
            try {
                if (!map.get("no_of_plans").equals("0")) {
                    holder.tv_total.setText("" + monthly_price * items);
                } else {
...
//                holder.tv_no_month.setText(map.get("price"));
        ...
        holder.iv_minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!map.get("no_of_plans").equals("0")) {
                    int palns_qty = Integer.valueOf(holder.tv_contetiy.getText().toString());
                    if (palns_qty > 1) {
                        palns_qty = palns_qty - 1;
                        dbHandler.update_no_flpan(palns_qty,map.get("product_id"));
                    }else {
                        palns_qty = 0;
                        dbHandler.update_no_flpan(palns_qty,map.get("product_id"));
                    }

//                    int no_of_form = Integer.valueOf(holder.tv_contetiy.getText().toString());
...
//        });
    ...
    class ProductHolder extends RecyclerView.ViewHolder {
        public TextView tv_title, tv_price, tv_total, tv_contetiy, tv_add, ttl ,dtx1, dtx2, d1, d2, dd1 ,dd2,service_txt
                ,tv_unit,tv_unit_value,tv_no_month;
        ...
        public ProductHolder(View view) {
            ...
            //+++++++++++++++++++++++++++++++++++++++++++++Fro Service+++++++++++++++++++
            service_txt = (TextView) view.findViewById(R.id.service_txt);
            tv_no_month = (TextView) view.findViewById(R.id.tv_no_month);
            //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
