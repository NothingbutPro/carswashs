...
public class My_order_detail_adapter extends RecyclerView.Adapter<My_order_detail_adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_title, tv_price, tv_qty, tv_unitval,month_plan;
        ...
        public MyViewHolder(View view) {
            ...
            month_plan = (TextView) view.findViewById(R.id.month_plan);
        }
    }
    ...
    public void onBindViewHolder(My_order_detail_adapter.MyViewHolder holder, int position) {
        ...
        if(mList.getPlan_type().equals("monthly"))
        {
            holder.tv_price.setText(mList.getMonthly_price());
        }else {
