...
public class BaseURL {
    ...
    public static final String BASEURL2 = "http://jntrcpl.com/Car_service";
   ...
   // public static final String GET_LIMITE_SETTING_URL = BASEURL2 + "grocery-store/index.php/api1/get_limit_settings";
    ...
    public static final String IMG_SLIDER_URL2 = BASEURL2 + "/uploads/sliders/";
  ...
  //  public static final String IMG_CATEGORY_URL = BASEURL2 + "grocery-store/uploads/category/";
    ...
    public static final String GET_SLIDER_URL2 = BASEURL2 + "/index.php/Api/get_sliders";
